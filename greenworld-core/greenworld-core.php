 ...
 * Description:       Business logic for Green World Health Solutions: automatic WhatsApp notifications (Meta Cloud API), scan bookings, and the customer health dashboard. In later phases, the distributor dashboard with points. Keeps this data independent of the active theme.
 * Version:           0.2.0
